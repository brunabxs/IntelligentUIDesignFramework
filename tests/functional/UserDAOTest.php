...
{
  public function testLoadInstanceById_userWithUserOidThatExists_mustSetInstanceToUserObject()
  {
    // Arrange
    $userDAO = $this->mockUserDAO();

    // Act
    $userDAO->loadInstanceById('9d3f75d2-4a72-11e4-b320-000df0ba9bdc');
  ...
  public function testLoadInstanceById_userWithUserOidThatDoesNotExist_mustSetInstanceToNull()
  {
    // Arrange
    $userDAO = $this->mockUserDAO();

    // Act
    $userDAO->loadInstanceById('4afaacf8-4a71-11e4-b320-000df0ba9bdc');
